    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-7">
          <div class="row mb-5">
            <div class="col-12 ">
              <h2 class="site-section-heading text-center">CSPL2.0 Gallery</h2>
            </div>
          </div>
        </div>
      ...
      <div class="row" id="lightgallery">
        <?php
          ...
          $query = "SELECT * FROM gallery WHERE 1"; //You don't need a ; like you do in SQL
        ...
        ?>
         <div class='col-sm-6 col-md-4 col-lg-3 col-xl-2 item' data-aos='fade' data-src='images/3.jpg'>
